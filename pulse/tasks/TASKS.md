...
**产品版本 V1.17.0｜接口契约 v1.1｜媒体库契约 v1.7.3｜全仓测试 634 项全绿。**
（补版本标签 `v1.17.0` 见文末「版本管理」——本版新增 A1/A3 两个域，按升版口径升 MINOR。）
...
| A6 独立验证 | W2 | **未开工** | `pulse/tests/` 不存在；634 项全是域内单测，无跨域集成与风控演练 |
...
- W2（A4 合规 / A5 平台前端 / A6 验证）**未启动**——W1 已出口，可以进场
  （并发上限 4：root + 最多 3 个子 agent，恰好 A4/A5/A6 一批）
