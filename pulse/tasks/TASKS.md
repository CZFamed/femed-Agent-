...
## 版本管理（V1.11.0 · 2026-09-11）

**当前版本 = V1.11.0**（`git tag` 可查）。三处版本号必须一致，由
`pulse/shared/tests/test_release_version.py` 守护（5 项）：

| 位置 | 当前取值 | 真源属性 |
| --- | --- | --- |
| `pyproject.toml` | `1.11.0` | `[project] version` |
| `pulse/__init__.py` | `1.11.0` | `pulse.__version__` |
| `CHANGELOG.md` | `## [1.11.0]` | 逐版本条目 |
